...
[![Build Status](https://api.travis-ci.org/itsjavi/bootstrap-colorpicker.svg?branch=v2.x)](https://travis-ci.org/itsjavi/bootstrap-colorpicker)

## Installation
For downloading the source code, you have many choices:

- Downloading the [latest v2.x source code ZIP file](https://github.com/itsjavi/bootstrap-colorpicker/archive/v2.x.zip)
...
- [Documentation and demos](https://itsjavi.com/bootstrap-colorpicker/v2/)
