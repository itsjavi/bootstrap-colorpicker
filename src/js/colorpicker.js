...
(function($) {
    ...
    Colorpicker.prototype = {
        ...
        _mousemove: function(e) {
            ...
            this._trigger('colorpickerMove', {'hsla': this._updateColorFromGuidelines()});
            return false;
        },
        _mouseup: function(e) {
            e.stopPropagation();
        ...
        _setPaletteColor: function(value, paletteElement, index, hoverText, className) {
            ...
            if (col.length > 0) {
                ...
                col.html($('<i class="colorpicker-palette-'+className
                        +'" data-colorpicker-palette-color="'+value
        ...
        _createPicker: function(customProps) {
            ...
            _picker.find('.colorpicker-map i').css({top: (this.options.baseHeight + 2) + "px", left: 2 + "px"});
            _picker.find('.colorpicker-bar i').css({top: ((this.options.baseHeight / 2) + 2) + "px", left: '0px'});
...
//
        ...
        setColor: function(val) {
            ...
            this._trigger('colorpickerChange', {value: val});
            return this.color;
        },
        /**
